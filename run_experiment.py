...
if __name__ == '__main__':
    ...
    parser.add_argument('--car', action='store_true', help='Run only car')
    parser.add_argument('--mushroom', action='store_true', help='Run only mushroom')
    ...
    if args.mushroom and args.car:
        logger.error("Can only specify one of '--car' or '--mushroom', not both")
        parser.print_help()
        sys.exit(1)
    ...
    if args.mushroom:
        datasets.append(mushroom_details)
    elif args.car:
        datasets.append(car_details)
    elif not args.mushroom and not args.car:
        datasets.append(mushroom_details)
        datasets.append(car_details)
